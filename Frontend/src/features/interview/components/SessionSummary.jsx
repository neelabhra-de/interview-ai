...
const SessionSummary = ({ data, onRestart }) => {
    ...
    const getPerformanceLevel = (score) => {
        if (score >= 8) return { level: 'Excellent', color: '#3fb950', emoji: '🌟' };
        if (score >= 7) return { level: 'Very Good', color: '#4a90e2', emoji: '⭐' };
        if (score >= 6) return { level: 'Good', color: '#f5a623', emoji: '👍' };
        if (score >= 4) return { level: 'Fair', color: '#ff9500', emoji: '📊' };
        return { level: 'Needs Work', color: '#ff4d4d', emoji: '💪' };
    };
        ...
        <div className="session-summary">
            <div className="summary-container">
                ...
                <div className="summary-header">
                    ...
                    <p className="summary-subtitle">Here's how you performed</p>
                </div>
                ...
                <div className="overall-score">
                    ...
                    <p className="score-level" style={{ color: performance.color }}>
                        {performance.level}
                    </p>
                </div>
                ...
                <div className="summary-section">
                    <h3 className="section-heading">🎯 Weak Areas to Focus On</h3>
                        ...
                        {summary.questionsDetail.map((q, idx) => (
                            <div key={idx} className="question-score-item">
                                ...
                                <div className="score-badge" style={{
                                    backgroundColor: q.score >= 7 ? '#3fb95020' : 
                                                   q.score >= 5 ? '#f5a62320' : '#ff4d4d20'
                                }}>
                                    <span style={{
                                        color: q.score >= 7 ? '#3fb950' : 
                                               q.score >= 5 ? '#f5a623' : '#ff4d4d'
                                    }}>
                                        {q.score}/10
                                    </span>
                                </div>
